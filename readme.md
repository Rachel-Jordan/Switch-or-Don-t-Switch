...
## How to install ##
*Click on the link at the top of the page. 1
*Then download the files GameShow.java and PlayGameShow.java 2
*Finally run the program in something like eclise or linux. 3
